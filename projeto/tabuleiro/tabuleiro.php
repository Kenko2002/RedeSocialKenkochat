        ...
        <div class="col-md-6 mt-5  mb-2" >
            ...
            <div class="card p-4 shadow" style="height:92vh;border-radius:0.25rem; background-color:#444;">
                    ...
                    <body>
                        ...
                        <div class="board_container scrollable" style="background-color:#333;height:100%;">
                            <div class="board"></div>
                        </div>
                        <div class="row" style="margin-left:0.03vw;">
                          ...
                          <button class="btn add_token_tabuleiro"style="border-color:white;padding:2px;border-radius:0px;margin:0px;color:white;background-color:#333">Inserir novo Token</button>
                          <button class="btn add_area_magia"style="border-color:white;padding:2px;border-radius:0px;margin:0px;color:white;background-color:#333">Inserir área de Efeito</button>
                          <button class="btn "style="border-color:white;padding:2px;border-radius:0px;margin:0px;color:white;background-color:#333">Fichas</button>
                          <button class="btn "style="border-color:white;padding:2px;border-radius:0px;margin:0px;color:white;background-color:#333">Recursos</button>
                        </button>
...
<div class="modal fade" id="modal_token_click" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header" style="background-color:#333">
      ...
      <div class="modal-footer"style="background-color:#333">
        ...
        <button type="button" id="token_click_confirmar" class="btn btn-secondary" style="background-color:#444" data-dismiss="modal">Confirmar</button>
        <button type="button" class="btn btn-secondary" style="background-color:#444" data-dismiss="modal">Cancelar</button>
        <!-- You can add additional buttons here if needed -->
      </div>
    </div>
