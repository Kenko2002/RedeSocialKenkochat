        ...
        success: function(data) {
            ...
            data.forEach(function(result) {
                ...
                //console.log('<div id="token_' + result.id + '" class="token"></div>');
                    ...
                    var tokenElement = $('<div class="token grabbable" id="token_' + result.id + '"></div>');
...
$(document).on("mousedown", function(event) {
    ...
    $(document).on("mousemove", function(event) {
        if($(event.target).hasClass("grabbable") || $(event.target).hasClass("cell")){
...
$(document).on("click", "#botao_editar_nota", function(){
    $.ajax({
        type: 'POST',
        url: './../api/tabuleiro.api.php',
        data: {
        ...
        success: function(data) {
            ...
            $("#botao_salvar_nota").css("display","block");
        },
        error: function(xhr, status, error) {
            console.log("Erro na solicitação AJAX: " + status + " - " + error);
        } 
...
$(document).on("click", "#botao_salvar_nota", function(){
    var id_notas_local=$(this).attr("id_nota");
    $.ajax({
        type: 'POST',
        url: './../api/tabuleiro.api.php',
        data: {
        ...
        success: function(data) {
            ...
            $.ajax({
                ...
                data: {
                    get_nota:"s",
                    id_nota:id_notas_local
                },
                dataType: 'html',
                success: function(data) {
                    $("#div_notas").empty().append(data);
                    $("#div_notas").attr("id_nota",id_notas_local);
                    $("#botao_editar_nota").attr("id_nota",id_notas_local);
                    $("#botao_salvar_nota").attr("id_nota",id_notas_local);
                    $("#botao_adicionar_nota").attr("id_nota",id_notas_local);
                    $("#botao_excluir_nota").attr("id_nota",id_notas_local);
...
$(document).on("click", "#botao_excluir_nota", function(){
    var id_nota_local=$(this).attr("id_nota");
    $.ajax({
        type: 'POST',
        url: './../api/tabuleiro.api.php',
        data: {
            delete_nota:"s",
            id_nota:id_nota_local
        },
        dataType: 'html',
        success: function(data) {
            callNotas();
            toastr.success("Nota Excluída com sucesso.","Sucesso!");
        },
        error: function(xhr, status, error) {
            console.log("Erro na solicitação AJAX: " + status + " - " + error);
        } 
...
$(document).on("click", "#botao_adicionar_nota", function(){
    $.ajax({
        type: 'POST',
        url: './../api/tabuleiro.api.php',
        data: {
        ...
        success: function(data) {
            callNotas();
            toastr.success("Nota criada com sucesso.","Sucesso!");
...
$(document).on("click", ".notas-button", function(){
        callNotas();
});


$(document).on("click", "#excluir_token_click_confirmar2", function(){
    var id_token_local=$(this).attr("id_token");
    $.ajax({
        type: 'POST',
        url: './../api/tabuleiro.api.php',
        data: {
...
$(document).on("click", "#token_click_duplicar2", function(){
    var id_token2=$(this).attr("id_token");
    $.ajax({
        type: 'POST',
        url: './../api/tabuleiro.api.php',
        data: {
...
$(document).ready(function(){
    $('.recursos-button').click(function(){
        query_recursos();
        setInterval(query_recursos,30000);
        $('#modal_recursos').modal('show');
    });
});
    
$(document).on("click", ".abrir_ficha_por_id", function(){
    id_token=$(this).attr("id_token");
    $('.button_fichas').click();
    $("#img_r_"+id_token).click();
